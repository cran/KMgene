#' KM for Quantitative Traits in Longitudinal GWAS Data (calculate p-value)
#'
...
#' @name LKM
#' @aliases LKM
#' @param obj results saved from LKM_Null_Model
...
#' @return output: longitudinal KM (L-KM) p-value
#' @examples
#' #########################################################################
...
#' weights=NULL)
#' @export
LKM <- function(obj, genotypes, gid, weights=NULL, acc=1e-4, append.write=NULL){
