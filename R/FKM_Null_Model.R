#' KM for continuous Traits in Familial GWAS Data (fit null model)
#'
...
#' @return output: object as input for FKM
#' @export
FKM_Null_Model <- function(phenotype, id, fa, mo, covariates=NULL){
