...
#' @name FbKM
#' @aliases FbKM
#' @param obj results saved from FbKM_Null_Model.
...
#' @return output: binary trait family KM (Fb-KM) p-value
#' @examples
#' #################################################################
...
#' weights=NULL)
#' @export
FbKM <- function(obj, genotypes, gid, weights=NULL, acc=1e-4, append.write=NULL){
# Regular checks
n = obj$n
