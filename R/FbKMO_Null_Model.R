...
#'
#' @name FbKMO_Null_Model
#' @aliases FbKMO_Null_Model
...
#' @include glmmPQL.R
#' @return output: object as input for FbKMO
#' @export
FbKMO_Null_Model <- function(phenotype, id, fa, mo, family="binomial", covariates=NULL){
